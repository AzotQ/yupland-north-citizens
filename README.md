...
Кратко про использование в интерфейсе:

- **Сделать первый снимок**: нажми **“Сделать снимок”** (первый раз сравнивать не с чем — diff будет пустым)
- **Сделать следующий снимок**: нажми **“Сделать снимок”** ещё раз — появятся изменения относительно предыдущего
- **Посмотреть последний снимок**: кнопка **“Показать последний снимок”**
- **Сравнить любые два снимка**:
  - выбери снимок **A** и **B** в таблице “Снимки”
  - нажми **“Сравнить A → B”**
  - diff покажет, кто **added/removed** при переходе от A к B
